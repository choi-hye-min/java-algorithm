...
public class PriorityQueueExample {
    public static void main(String[] agrs) {
        ...
        Node node1 = priorityQueueExample.new Node(3d, 3d);
        Node node2 = priorityQueueExample.new Node(5d, 7d);
        Node node3 = priorityQueueExample.new Node(1d, 8d);
        Node node4 = priorityQueueExample.new Node(8d, 12d);
